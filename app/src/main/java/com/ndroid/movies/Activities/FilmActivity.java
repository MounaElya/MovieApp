...
import com.ndroid.movies.Adapters.CategoryListAdapter;
import com.ndroid.movies.Adapters.FilmListAdapter;
import com.ndroid.movies.Adapters.SliderAdapters;
import com.ndroid.movies.Domain.GenresItem;
import com.ndroid.movies.Domain.ListFilm;
import com.ndroid.movies.Domain.SliderItems;
...
public class FilmActivity extends AppCompatActivity {
    ...
    private void sendRequestBestMovies() {
        ...
        mStringRequest=new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies?page=1", response -> {
            ...
            loading1.setVisibility(View.GONE);
            Log.i("Mouna","onErrorResponse: "+ error.toString());
        });
